        ...
        <div id="main">
            ...
            <div class="page-heading">
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable modal-xl"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel16">Add a branch</h4>
                                        ...
                                        <div class="me-1 mb-1 d-inline-block">
                                            ...
                                            <div class="modal fade text-left w-100" id="xlarge1" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable modal-xl"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel16">Update branch</h4>
                                                            <button type="button" class="close" data-bs-dismiss="modal"
                                                                aria-label="Close">
                                                                <i data-feather="x"></i>
                                                            </button>
                                                    ...
                                                    <input class="form-control" name="phone1" id="phone1">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary ml-1"
                                                                ...
                                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                                <span class="d-none d-sm-block">Update Branch</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <script type="text/javascript">
												...
												function update(ids){
													...
													$.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"calData.jsp",
										        		  data:{"myid" :ids,"option":'showBranch'},
												 ...
												 function add(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"calData.jsp",
										        		  data:{"Name":$("#Name1").val() ,"location":$("#location").val(),"manager":$("#manager").val(),"phone":$("#phone").val(),"option":'addBranch'},
												 ...
												 function edit(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"calData.jsp",
										        		  data:{"myid" :id,"Name":$("#Name11").val() ,"location":$("#location1").val(),"manager":$("#manager1").val(),"phone":$("#phone1").val(),"option":'editSta'},
                ...
                <section class="section">
                    ...
                    <table id="table2" class="table table-hover table table-sm" cellpadding="0" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th></th>
                                        <th></th>
