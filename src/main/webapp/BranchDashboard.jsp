         ...
         <div class="modal-content">
			...
			<label for="" class="mt-1">Select Union</label>
				...
				<%
					...
					ResultSet rst = st.executeQuery(sql5);
					while(rst.next()){
				%>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Total Branch Stations</h6>
                                                <h4><div id="tSta"></div></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Branch Monthly Trip Count </h4>
                                    </div>
                                    <div class="card-body">
                                        <div id="chart"></div>
