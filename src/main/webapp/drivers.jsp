                 ...
                 <!--Modal Xl size -->
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable modal-xl"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel16">Add a Driver</h4>
                                   ...
                                   <!-- Employee Details  -->
										...
										<label for="" class="mt-1">Gender</label>
											<select name="gender" id="gender" class="choices form-select">
												<option value=""></option>
												<option > Male</option>
                                                    ...
                                                    <input class="form-control" name="ephone" id="ephone">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary ml-1"
                                                                data-bs-dismiss="modal" onclick="addDriver()">
                                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                                <span class="d-none d-sm-block">Add Driver</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="me-1 mb-1 d-inline-block">
                                            ...
                                            <div class="modal fade text-left w-100" id="xlarge1" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable modal-xl"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel16">Update Driver Data</h4>
                                                            <button type="button" class="close" data-bs-dismiss="modal"
                                                                aria-label="Close">
                                                                <i data-feather="x"></i>
                                                            </button>
